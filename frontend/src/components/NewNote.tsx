            ...
            {!isRecording && !isProcessing && (
              <div className="flex flex-col items-center space-y-3">
                <button
                  ...
                  className="p-6 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-full transition-colors"
                >
            ...
            {isRecording && (
              <div className="flex flex-col items-center space-y-3">
                <button
                  ...
                  className="p-6 bg-red-600 hover:bg-red-700 text-white rounded-full transition-colors animate-pulse"
                >
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8 7a1 1 0 00-1 1v4a1 1 0 001 1h4a1 1 0 001-1V8a1 1 0 00-1-1H8z" clipRule="evenodd" />
                  </svg>
                </button>
                <span className="font-medium text-gray-700">Stop Recording</span>
              </div>
            )}

...
const ScribePage: React.FC = () => {
  ...
  const scribeSessions: ScribeSession[] = [
    {
      id: '1',
      patientId: 'PT-001',
          ...
          {!isHistoryCollapsed && (
            <>
              ...
              <button
                ...
                className="w-full bg-amber-600 hover:bg-amber-700 text-white px-4 py-3 rounded-lg font-medium mb-6 flex items-center justify-center space-x-2"
              >
                <span>🎤</span>
                <span>🤖</span>
              ...
              <div className="space-y-2">
                ...
                {scribeSessions.map((session) => (
                  ...
                  >
                    ...
                    <div className="text-sm opacity-75">ID: {session.patientId}</div>
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          {selectedSession ? (
            <div>
              {/* Patient Header */}
              <div className="mb-6">
                <h1 className="text-3xl font-bold text-white mb-2">{selectedSession.patientName}</h1>
              ...
              <div className="mt-8 bg-gray-800 rounded-lg p-4">
                <h3 className="text-white font-medium mb-3">Suggest Changes</h3>
                <textarea
                  value={feedback}
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center text-gray-400">
                ...
                <h2 className="text-xl font-medium mb-2">Select a session to view details</h2>
        ...
        <div className="w-80 bg-gray-800 border-l border-gray-700 p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-4 py-3 rounded-lg font-medium"
            >
